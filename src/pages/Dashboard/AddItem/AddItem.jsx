    ...
    <div className="card shrink-0 w-full shadow-2xl bg-base-100">
      <form onSubmit={handleSubmit(onSubmit)} className="card-body">
        ...
        <div className="form-control">
          ...
          <select className='input input-bordered' {...register("item_category")}>
        ...
        <div className="form-control">
          ...
          <input {...register("item_price", { required: true })} type="number" placeholder="Price" className="input input-bordered" />
        ...
        <div className="form-control">
         ...
         <textarea {...register("item_recipe", { required: true })} className='border  p-2' placeholder="Recipe Details*" id="" cols="30" rows="7" ></textarea>
